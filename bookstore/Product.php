        ...
        <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
            <div>
                <form role="search" action="Result.php" method="post">
                    <input type="text" name="keyword" class="form-control" placeholder="Поиск книги, автора или категории" style="width:80%;margin:20px 10% 20px 10%;">
                </form>
            </div>
        </div>
             ...
             <div class="row">
                  <div class="col-sm-5 col-sm-offset-6 col-md-5 col-md-offset-7 col-lg-4 col-lg-offset-8">
                       <form action="';echo $_SERVER['PHP_SELF'];echo'" method="post" class="pull-right">
                           <label for="sort">Сортировать &nbsp: &nbsp</label>
                            <select name="sort" id="select" onchange="form.submit()">
                                <option value="default" name="default"  selected="selected">Select</option>
                                <option value="price" name="price">От низкой до высокой цены </option>
                                <option value="priceh" name="priceh">От высокой до низкой цены </option>
                                <option value="discountl" name="discountl">Скидка от низкой до высокой </option>
                                <option value="discount" name="discount">Скидка от высокой до низкой</option>
                            </select>
                       </form>
                  </div>
              </div>
