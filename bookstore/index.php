...
?>
      ...
      <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
          <div>
              <form role="search" method="POST" action="Result.php">
                  <input type="text" class="form-control" name="keyword" style="width:80%;margin:20px 10% 20px 10%;" placeholder="Поиск книги, автора или категории">
              </form>
          </div>
      </div>
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              <div class="col-md-3 col-lg-3" id="category">
                  ...
                  <ul>
                      <li> <a href="Product.php?value=entrance%20exam"> Вступительный экзамен </a> </li>
                      <li> <a href="Product.php?value=Literature%20and%20Fiction"> Литература & худ. литература </a> </li>
                      <li> <a href="Product.php?value=Academic%20and%20Professional"> Академ. & проф. </a> </li>
                      <li> <a href="Product.php?value=Biographies%20and%20Auto%20Biographies"> Биографии & автобиографии </a> </li>
                      <li> <a href="Product.php?value=Children%20and%20Teens"> Дети & подростки </a> </li>
                      <li> <a href="Product.php?value=Regional%20Books"> Региональные книги </a> </li>
                      <li> <a href="Product.php?value=Business%20and%20Management"> Бизнес & менеджмент </a> </li>
                      <li> <a href="Product.php?value=Health%20and%20Cooking"> Здоровье и кулинария </a> </li>
  ...
  <div class="container-fluid" id="author">
      <h3 style="color:#D67B22;"> ПОПУЛЯРНЫЕ АВТОРЫ </h3>
      <div class="row">
