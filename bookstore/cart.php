        ...
        if(isset($_GET['place']))
                 ...
                 ?>
                    <script type="text/javascript">
                         alert("Заказ успешно размещен!!! Пожалуйста, держите наличные наготове. Они будут собраны при доставке");
                    </script>
                 <?php                  
                  }
...
echo '<div class="container-fluid" id="cart">
      <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:#D67B22;text-transform:uppercase;">  ВАША КОРЗИНА </h2>
           </div>
        </div>';
	if(isset($_SESSION['user']))
	    {   
                                 ...
                                 echo '                
                                      <div class="panel col-xs-12 col-sm-4 col-sm-offset-'.$offset.' col-md-4 col-md-offset-'.$offset.' col-lg-4 col-lg-offset-'.$offset.' text-center" style="color:#D67B22;font-weight:800;">
                                          ...
                                          <div class="panel-body">
                                                            ...
                                                            Название : '.$row['Title'].'  <br> 
                                                                                      Код : '.$row['PID'].'     <br>        	 
                                                                        Автор : '.$row['Author'].' <br>                            	      
                                                                        Издание : '.$row['Edition'].' <br>
                    ...
                    echo '<div class="container">
                     ...
                     echo '<div class="row">
                             <div class="col-xs-8 col-xs-offset-2  col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-3 col-lg-4 col-lg-offset-3">
                                  <a href="index.php" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Продолжить покупки</a>
                             </div>
                             <div class="col-xs-6 col-xs-offset-3 col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-1 col-lg-4 ">
                                  <a href="cart.php?place=true" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;margin-top:5px;">Разместить заказ</a>
                             </div>
                           </div>
                           ';
                } 
                        ...
                        echo ' 
                         ...
                         <div class="row">
                             <div class="col-xs-9 col-xs-offset-3 col-sm-2 col-sm-offset-5 col-md-2 col-md-offset-5">
                                  <a href="index.php" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Сделайте несколько покупок</a>
                             </div>
                          </div>';
                     }               
	    }
	    ...
	    { 
	          echo "войдите в систему, чтобы продолжить";
	    }
        echo '</div>';
	?>
