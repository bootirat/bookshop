...
echo'                           <br><br><br>
                                <a id="buyLink" href="'.$target.'" class="btn btn-lg btn-danger" style="padding:15px;color:white;text-decoration:none;"> 
                                    ДОБАВИТЬ В КОРЗИНУ '.$row["Price"] .' <br>
...
echo '
   ...
   НАЗВАНИЕ         '.$row["Title"].' <hr> 
   АВТОР         '.$row["Author"].' <hr>
   ДОСТУПНО     '.$row["Available"].' <hr> 
   ИЗДАТЕЛЬ     '.$row["Publisher"].' <hr> 
   ИЗДАНИЕ          '.$row["Edition"].' <hr>
   ЯЗЫК             '.$row["Language"].' <hr>
   СТРАНИЦЫ         '.$row["page"].' <hr>
   ВЕС               '.$row["weight"].' <hr> 
                        </pre>
    </div>
  </div>
